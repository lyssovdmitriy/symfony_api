...
final class UserDTO
{
    ...
    #[Assert\NotBlank(message: 'The password value should not be blank.')]
    #[Groups(['create', 'update'])]
    public string $password;

    #[OA\Property(example: '1980-01-25')]
    #[Assert\NotBlank(message: 'The birthday value should not be blank.')]
    #[Assert\Date(message: 'The date {{ value }} is not a valid date.')]
    #[Groups(['get', 'create', 'update'])]
    public string $birthday;

    #[OA\Property(example: '+98123456789')]
    #[Assert\NotBlank(message: 'The phone value should not be blank.')]
    #[Groups(['get', 'create', 'update'])]
    public string $phone;

    #[OA\Property(example: 'Mozart street 1')]
    #[Assert\NotBlank(message: 'The address value should not be blank.')]
    #[Groups(['get', 'create', 'update'])]
